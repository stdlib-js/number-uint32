...
```javascript
ns = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/number-uint32@v0.3.0-umd/browser.js' )
```
...
[test-image]: https://github.com/stdlib-js/number-uint32/actions/workflows/test.yml/badge.svg?branch=v0.3.0
[test-url]: https://github.com/stdlib-js/number-uint32/actions/workflows/test.yml?query=branch:v0.3.0
